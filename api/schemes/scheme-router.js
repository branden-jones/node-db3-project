...
router.use((err, req, res, next) => { // eslint-disable-line
  res.status(err.status || 500).json({
    sageAdvice: 'Finding the real error is 90% of the bug fix', // You all make me laugh..
    message: err.message,                                       // sageAdvice and songs of 
    stack: err.stack,                                           // encouragement... soo good!!
  })
})
